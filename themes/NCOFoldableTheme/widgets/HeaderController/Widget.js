  ...
  function(declare, lang, array, html, aspect, query, on, Deferred, mouse,
    ...
    var clazz = declare([BaseWidget, PoolControllerMixin], {
      ...
      postCreate: function() {
		...
		// MEJORAS NCO
		if (dojoConfig.locale === "es") {
			this.imgFlagES.src = this.folderUrl + 'images/bandera-es.png';
			this.imgFlagES.title = this.nls.esActivo;
			this.imgFlagEN.src = this.folderUrl + 'images/bandera-en.png';
			this.aImgFlagES.style.cursor = "default";			
			this.imgFlagEN.title = this.nls.seleccionarEN;
			this.aImgFlagEN.href = "?locale=en";
		}
		else {
			this.imgFlagES.src = this.folderUrl + 'images/bandera-es.png';
			this.imgFlagES.title = this.nls.seleccionarES;
			this.imgFlagEN.src = this.folderUrl + 'images/bandera-en.png';
			this.imgFlagEN.title = this.nls.enActivo;
			this.aImgFlagEN.style.cursor = "default";
			this.aImgFlagES.href = "?locale=es";
		}
		// MEJORAS NCO
      },
      ...
      _createIconNodes: function(box) {
		...
		containerStyle[marginProperty] = (ret.emptyWidth - 28) + 'px';
		// MEJORAS NCO
